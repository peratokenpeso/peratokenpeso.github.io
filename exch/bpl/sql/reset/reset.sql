...
INSERT INTO `network_admin` (`id`, `username`, `password`, `admintype`)
VALUES (1, 'superadmin', '63a9f0ea7bb98050796b649e85481845', 'Super');
...
(
    ...
    `status`             enum ('inactive','active','reactivated','graduate') COLLATE utf8mb4_unicode_ci DEFAULT 'inactive',
...
INSERT INTO `network_binary` (`user_id`, `position`, `status`, `status_cycle`, `date_last_flushout`)
VALUES (1, 'Head', 'active', 1, UNIX_TIMESTAMP());
...
INSERT INTO `network_points` (`user_id`)
VALUES (1);
...
INSERT INTO `network_compound` (`user_id`, `time_last`, `value_last`, `day`, `processing`, `maturity`,
                                `time_mature`)
...
INSERT INTO `network_fixed_daily` (`user_id`, `time_last`, `value_last`, `day`, `processing`, `time_mature`)
VALUES (1, 0, 0, 0, 0, 0);
...
INSERT INTO `network_fmc` (`balance`, `sales_fmc`, `purchase_fmc`, `price_btc`)
...
INSERT INTO `network_harvest` (`user_id`)
VALUES (1);
...
INSERT INTO `network_harvest_associate` (`user_id`, `has_mature`, `is_active`)
VALUES (1, 0, 1);
...
INSERT INTO `network_harvest_basic` (`user_id`, `has_mature`, `is_active`)
VALUES (1, 0, 1);
...
(
    ...
    `status`          enum ('Awaiting Delivery','Delivered') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Awaiting Delivery',
...
INSERT INTO `network_indirect` (`id`, `user_id`)
VALUES (1, 1);
...
INSERT INTO `network_leadership` (`user_id`)
VALUES (1);
...
INSERT INTO `network_leadership_passive` (`user_id`)
VALUES (1);
...
INSERT INTO `network_matrix` (`user_id`)
VALUES (1);
...
INSERT INTO `network_matrix_associate` (`user_id`, `is_active`)
VALUES (1, 1);
...
INSERT INTO `network_matrix_basic` (`user_id`, `is_active`)
VALUES (1, 1);
...
INSERT INTO `network_matrix_executive` (`user_id`, `is_active`)
VALUES (1, 1);
...
INSERT INTO `network_matrix_regular` (`user_id`, `is_active`)
VALUES (1, 1);
...
INSERT INTO `network_power_basic` (`user_id`, `is_active`)
VALUES (1, 1);
...
INSERT INTO `network_share_basic` (`user_id`, `is_active`)
VALUES (1, 1);
...
INSERT INTO `network_unilevel` (`user_id`)
VALUES (1);
