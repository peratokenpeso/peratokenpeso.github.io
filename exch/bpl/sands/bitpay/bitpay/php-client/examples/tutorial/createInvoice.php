...
$token->setToken('D8ZQB1HSJqejJzyLtqz4S7dGzY9Z8QpRUzkYmHdCTuAb'); // UPDATE THIS VALUE
...
$invoice
        ->setItem($item)
        ->setNotificationEmail('info@grapyhost.com')
        ->setNotificationUrl('https://sitenow.host/vendor/bitpay/php-client/examples/tutorial/IPNlogger.php')
        ->setRedirectUrl('https://sitenow.host/success.php')
